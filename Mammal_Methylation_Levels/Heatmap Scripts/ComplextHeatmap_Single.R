...
### Uncomment this for Human Methylation
...
# mat <- as.matrix(clock1_top100_methylation[, -1]) # Clock 1 Methylation Data
mat <- as.matrix(human_methylation_data[, -1]) # Human Methylation Data
...
filename <- file.path(heatmap_dir, "GSE184211_Heatmap.png")
