...
file_names <- c(
  ...
  # "clock2_relevant_annotated_cpgs.csv",
  # "clock3_relevant_annotated_cpgs.csv",
  # "overlap_1_2_3_relevant_annotated_cpgs.csv",
  # "overlap_2_3_relevant_annotated_cpgs.csv"
) 
...
for (file_name in file_names) {
  # create file path
  file_path <- here("FunctionalAnalysis/Annotations", file_name)
...
gene_set_data_list <- list(
  ...
  # "Clock 2" = cpgs_data_list[["clock2_relevant_annotated_cpgs.csv"]],
  # "Clock 3" = cpgs_data_list[["clock3_relevant_annotated_cpgs.csv"]],
  # "Overlap of Clocks 1, 2 & 3" = cpgs_data_list[["overlap_1_2_3_relevant_annotated_cpgs.csv"]],
  # "overlap of Clocks 2 & 3" = cpgs_data_list[["overlap_2_3_relevant_annotated_cpgs.csv"]]
)
