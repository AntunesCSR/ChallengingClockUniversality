### KEGG Analysis for relevant CpGs in each clock and the overlap between Clock 2 and Clock 3 identifies by clustering

# AUthor: Dr. Catia Antunes
# Date: 15/07/2024
# Description: This script performs KEGG analysis relevant CpGs in each clock and the overlap between Clock 2 and Clock 3. 
...
output_folder <- here("FunctionalAnalysis/Functional_Enrichment/KEGG_Analysis_relevant_CpGs")
