### KEGG Analysis for the top 100 CpGs in each clock and the overlap between Clock 2 and Clock 3

# AUthor: Dr. Catia Antunes
# Date: 15/07/2024
# Description: This script performs KEGG analysis for the top 100 CpGs in each clock and the overlap between Clock 2 and Clock 3. 
...
gene_set_data_list <- list(
  "Clock_1_TOP100" = cpgs_data_list[[file_names[1]]],
  "Clock_2_TOP100" = cpgs_data_list[[file_names[2]]],
  "Clock_3_TOP100" = cpgs_data_list[[file_names[3]]],
  "Clock_2_3_overlap_TOP100" = cpgs_data_list[[file_names[4]]]
)

# Select the output folder
output_folder <- here("FunctionalAnalysis/Functional_Enrichment/KEGG_Analysis_Clocks/Results - TOP100/")
