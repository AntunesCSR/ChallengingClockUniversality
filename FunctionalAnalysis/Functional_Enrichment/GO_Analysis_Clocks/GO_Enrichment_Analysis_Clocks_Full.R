######################################################################################################
###################### Gene Ontology (GO) Enrichment Analysis of Epigenetic Clocks ####################
######################################################################################################

# Title: Gene Ontology (GO) Enrichment Analysis Script of All Clocks 
...
for (file_name in file_names) {
  file_path <- here("FunctionalAnalysis", file_name)  ### Update path depending analysis
...
gene_set_data_list <- list(
  ...
  "Clocks_2_3_overlap_full" = cpgs_data_list[[file_names[4]]]
)

### Set the output folder
output_folder <- here("FunctionalAnalysis/Functional_Enrichment/GO_Analysis_Clocks/Results - Clocks Full/")
