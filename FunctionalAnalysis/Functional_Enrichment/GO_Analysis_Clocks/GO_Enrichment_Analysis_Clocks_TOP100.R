###################################################################################################################
###################### Gene Ontology (GO) Enrichment Analysis for top 100 CpGs of each clock ######################
###################################################################################################################
...
for (file_name in file_names) {
  file_path <- here("FunctionalAnalysis", file_name) ### updated depending on the location of the data
...
output_folder <- here("FunctionalAnalysis/Functional_Enrichment/GO_Analysis_Clocks/Results - TOP100/")
